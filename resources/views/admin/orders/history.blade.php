        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">History Order Lists</h5>
                    <p class="m-b-0">Histroy Orders View Lists</p>
                </div>
            </div>
            <div class="col-md-4">
              ...
              <div class="page-body ">
                  <div class="row">
                      ...
                      <div class="col-xl-12 col-md-12">
                        <a class="btn btn-mat btn-sm waves-effect waves-light btn-success mb-4" href="{{url('orders')}}">New Orders</a>
